...
def measure_get_orders_performance(num_queries, customer_id):
    ...
    for _ in range(num_queries):
        get_orders_by_user(customer_id)
...
def measure_order_cost_performance(num_queries, user_id, order_id):
    ...
    start_time = time.time()
    for _ in range(num_queries):
        get_order_cost(user_id, order_id)
    elapsed_time = time.time() - start_time
    average_time = elapsed_time / num_queries
    print(
...
def measure_supplier_retrieval_performance(num_queries, supplier_name):
    ...
    start_time = time.time()
    for _ in range(num_queries):
        get_supplier_by_name(supplier_name)
    elapsed_time = time.time() - start_time
    average_time = elapsed_time / num_queries
    print(
...
if __name__ == "__main__":
    num_queries = 5
    test_customer_id = "89303"  # Example customer ID
    test_customer_name = "richard77"  # Example customer ID
    test_customer_id_2 = "54576"  # Example customer ID
    test_product_name = "8881"  # Example product name
    test_order_id = "22219"  # Example product name
    test_supplier_name = "Perry-Dunn"  # Example product name
    base_supplier_name = "TEST_SUPPLIER_NAME"  # Example product name
    base_supplier_id = "23456"
    base_product_id, base_product_name = "12345", "TEST_PRODUCT_NAME"
